# Generated by Django 3.2.13 on 2022-06-22 17:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('story_title', models.CharField(max_length=100, verbose_name='Story Title')),
                ('story_overview', models.TextField(default='', verbose_name='Story Overview')),
                ('story_content', tinymce.models.HTMLField(verbose_name='Story Content')),
                ('story_image', models.ImageField(upload_to='story_image', verbose_name='Story Image')),
                ...
                ('story_sub_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.subcategory')),
